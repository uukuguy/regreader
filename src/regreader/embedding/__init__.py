...
使用方式:
    from regreader.embedding import create_embedder, BaseEmbedder, EmbedType
...
if TYPE_CHECKING:
    from regreader.embedding.flag import FlagEmbedder
    from regreader.embedding.sentence_transformer import SentenceTransformerEmbedder
