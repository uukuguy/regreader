...
def create_tools(
    ...
    Returns:
        工具实例（本地 RegReaderTools 或 MCP 适配器）
    ...
    return RegReaderMCPToolsAdapter(transport=transport, server_url=server_url)
...
class ToolsContext:
    ...
    def __init__(
        ...
        self._tools: "RegReaderToolsProtocol | None" = None

    def __enter__(self) -> "RegReaderToolsProtocol":
