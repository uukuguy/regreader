...
| 文件 | 修改内容 |
|------|----------|
| `src/grid_code/config.py` | 添加工具集配置开关 |
| `src/grid_code/mcp/tool_metadata.py` | 更新工具元数据，移除被删除的工具 |
| `src/grid_code/mcp/server.py` | 根据配置动态注册工具 |
| `src/grid_code/agents/prompts.py` | 更新系统提示词，嵌入工具使用指南 |
