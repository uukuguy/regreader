...
本文档描述 RegReader Agent 记忆系统的设计与实现，用于优化多轮工具调用效率。
...
| 文件 | 修改类型 | 说明 |
|------|----------|------|
| `src/regreader/agents/memory.py` | 新增 | AgentMemory 核心模块 |
| `src/regreader/agents/pydantic_agent.py` | 修改 | 集成记忆系统 |
| `src/regreader/agents/claude_agent.py` | 修改 | 集成记忆系统 |
