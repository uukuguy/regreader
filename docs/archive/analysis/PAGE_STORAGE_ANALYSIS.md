# RegReader 页面存储数据结构与页号检索机制分析报告

## 一、核心数据模型

### 1. PageDocument - 单页文档（核心存储单位）

**文件位置**: `src/regreader/storage/models.py:57-93`
...
**文件位置**: `src/regreader/storage/models.py:42-54`
...
**文件位置**: `src/regreader/storage/models.py:21-31`
...
**文件位置**: `src/regreader/storage/models.py:131-146`
...
**实现位置**: `src/regreader/storage/page_store.py:40-42`
...
**文件位置**: `src/regreader/storage/page_store.py:112-137`
...
**文件位置**: `src/regreader/storage/page_store.py:139-180`
...
**文件位置**: `src/regreader/storage/page_store.py:182-242`
...
### RegReaderTools.read_page_range()

**文件位置**: `src/regreader/mcp/tools.py:96-142`
...
**文件位置**: `src/regreader/mcp/server.py`
...
**文件位置**: `src/regreader/index/keyword/fts5.py`
...
**文件位置**: `src/regreader/index/vector/lancedb.py`
...
**文件位置**: `src/regreader/exceptions.py`
...
| 组件 | 文件路径 |
|------|---------|
| 数据模型 | `src/regreader/storage/models.py` |
| 页面存储 | `src/regreader/storage/page_store.py` |
| MCP 工具 | `src/regreader/mcp/tools.py` |
| MCP Server | `src/regreader/mcp/server.py` |
| FTS5 索引 | `src/regreader/index/keyword/fts5.py` |
| LanceDB 索引 | `src/regreader/index/vector/lancedb.py` |
| 异常定义 | `src/regreader/exceptions.py` |
| 配置文件 | `src/regreader/config.py` |
